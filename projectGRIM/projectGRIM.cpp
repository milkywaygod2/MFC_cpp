// projectGRIM.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
#include "pch.h"
#include "framework.h"
...
// CprojectGRIMApp
BEGIN_MESSAGE_MAP(CprojectGRIMApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()

// CprojectGRIMApp 생성
CprojectGRIMApp::CprojectGRIMApp() {
	// 다시 시작 관리자 지원
...
// 유일한 CprojectGRIMApp 개체입니다.
CprojectGRIMApp theApp;

// CprojectGRIMApp 초기화
BOOL CprojectGRIMApp::InitInstance() {
	...
	// 표준 초기화
	// 이들 기능을 사용하지 않고 최종 실행 파일의 크기를 줄이려면 아래에서 필요 없는 특정 초기화 루틴을 제거해야 합니다. 해당 설정이 저장된 레지스트리 키를 변경하십시오.
